...
- name: dimension
  required: false
  description: 'Audit one dimension only. Code track: critical-path, security, privacy, correctness, concurrency, resilience, dead-ends, honesty, performance, naming, docs, tests, supply-chain, accessibility, ops. Business track: go-to-market, business-ops. Omit to let the rotation pick.'
dry_run: true
---
