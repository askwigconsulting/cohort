...
- name: dimension
  required: false
  description: Audit one dimension only (critical-path, security, correctness, concurrency, resilience, dead-ends, honesty, performance, naming, docs, tests, supply-chain, accessibility, ops). Omit to let the rotation pick.
dry_run: true
---
