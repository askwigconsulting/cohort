...
with `cohort submit-proposals --upstream` (sanitized, draft PR to the upstream Cohort repo). Keep
project-specific proposals local. A human always confirms before anything goes upstream.
