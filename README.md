...
| Holds | the 19-agent roster, hooks, memories, skills | personal agents/memories (`add-agent`, `add-memory`, and `adopt` land here by default) | `project_context.md`, `sessions/`, project specialists, `proposals/`, `feedback/` |
